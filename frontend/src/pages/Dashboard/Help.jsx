...
const Help = () => {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col p-6 w-[90%] ml-20">
      <header className="bg-gradient-to-r from-blue-950 to-blue-900 text-white p-6 rounded-lg shadow-lg mx-auto max-w-7xl h-45 flex items-center justify-between">
        <div className="flex flex-col justify-center h-full">
          ...
          <p className="text-sm">
            Need assistance? Visit our Help section for support and FAQs!
          </p>
        </div>
      ...
      <main className="flex-grow p-4">
        ...
        <section className="mt-8">
          <button
            ...
            className="bg-gradient-to-r from-yellow-400 to-orange-500 hover:from-yellow-500 hover:to-orange-500 text-white py-[10px] px-8  rounded-lg shadow-lg mb-4  transition duration-300"
          >
