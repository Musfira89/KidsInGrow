    ...
    <div className="relative rounded-xl overflow-hidden backdrop-blur-lg shadow-lg border border-gray-200 transform hover:scale-105 transition-transform duration-300">
      <div className="relative">
        <img
          ...
          alt={heading}
        />
        <div className="absolute bottom-0 left-0 w-full h-40 bg-gradient-to-t from-transparent via-transparent to-white opacity-0 hover:opacity-40 transform rotate-180"></div> {/* Mirror effect */}
      </div>
      <div className="p-4">
        <div className="text-yellow-500 font-bold text-[5rem]"> {/* Increased font size */}
          {heading}
        </div>
